...
public class Session extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        request.getSession().setAttribute("superior", superior);
        request.getSession().setAttribute("inferior", inferior);
        ...
        // enlace para volver a la página formulariosession.jsp
        out.println("<a href='formulariosession.jsp' class='btn btn-primary mt-3'>Volver al formulario</a>");
